  ...
  <body class="bg-gradient-primary">
                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    <div class="text-center">
                      <h1 class="h4 text-gray-900 mb-1">Não é cadastrado?</h1>
                      <h4 class="h6 text-gray-900 mb-4">Então crie seu login e senha.</h4>
                    </div>
                    <form class="user">
                    ...
                    <hr>
                    <div class="text-center">
                      <a class="small" href="login.html">Entre em sua conta!</a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <script>
      function login() {
        ...
        $.post('../backend/routes/CreateUser.php', {
          login: $("#login").val(),
